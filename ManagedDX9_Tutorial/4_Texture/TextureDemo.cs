...
// TextureDemo.cs
// Coder: Thobias Jones
// Purpose: Managed DirectX 9 triangle with texture
...
namespace Genkisoft
{
    public class DX9Demo : System.Windows.Forms.Form
    {
        ...
        private static Direct3D.CustomVertex.TransformedColoredTextured[] m_aVertices =
        {
            new Direct3D.CustomVertex.TransformedColoredTextured(120.0f, 120.0f, 1.0f, 1.0f, 0,            0.5f, 0.0f),
            new Direct3D.CustomVertex.TransformedColoredTextured(200.0f, 200.0f, 1.0f, 1.0f, 0,            1.0f, 1.0f),
            new Direct3D.CustomVertex.TransformedColoredTextured(30.0f,  200.0f, 1.0f, 1.0f, int.MaxValue, 0.0f, 1.0f),
        };
