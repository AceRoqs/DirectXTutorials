...
// ShaderHLSLDemo.cs
// Coder: Thobias Jones
// Purpose: Managed DirectX 9 spinning cube using HLSL shaders
...
namespace Genkisoft
{
    public class DX9Demo : System.Windows.Forms.Form
    {
        ...
        private void InitDirect3D()
        {
            ...
            System.IO.Stream stream = assembly.GetManifestResourceStream("_7_ShaderHLSL.Shader.fx");

            Direct3D.GraphicsStream gs = Direct3D.ShaderLoader.CompileShaderFromStream(stream, "VertexShader", null, "vs_1_1", (int)shaderFlags);
            vertexShader = new Direct3D.VertexShader(device, gs);
            gs.Close();

            stream.Seek(0, System.IO.SeekOrigin.Begin);

            gs = Direct3D.ShaderLoader.CompileShaderFromStream(stream, "PixelShader", null, "ps_1_1", (int)shaderFlags);
        ...
        public void OnDeviceReset(object sender, System.EventArgs e)
        {
            ...
            System.Reflection.Assembly assembly = System.Reflection.Assembly.GetExecutingAssembly();
            System.IO.Stream stream = assembly.GetManifestResourceStream("_7_ShaderHLSL.photo.png");
