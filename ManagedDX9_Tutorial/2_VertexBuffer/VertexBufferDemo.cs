...
// VertexBufferDemo.cs
// Coder: Thobias Jones
// Purpose: Managed DirectX 9 vertex buffer triangle
...
namespace Genkisoft
{
    public class DX9Demo : System.Windows.Forms.Form
    {
        ...
        private void DrawScene()
        {
            ...
            device.BeginScene();
            device.DrawPrimitives(Direct3D.PrimitiveType.TriangleList, 0, m_aVertices.Length / 3);
            device.EndScene();
            device.Present();
        }
    }
